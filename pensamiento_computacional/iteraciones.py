...
# La mayoría del tiempo los números flotantes (tipo float) son una muy buena aproximación
# de los números que queremos calcular con nuestras computadoras. Sin embargo, “la
# mayoría del tiempo” no significa todo el tiempo, y cuando no se comportan de esta manera
